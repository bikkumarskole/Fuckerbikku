...
Y8888P' Y888888P YP   YD YP   YD ~Y8888P'e u real programmer:)
#      Coded By Yayan XD.
...
def loading():
    ...
    print("")
# LOGO
def logo():d8888b. d888888b db   dD db   dD db    db 
88  `8D   `88'   88 ,8P' 88 ,8P' 88    88 
88oooY'    88    88,8P   88,8P   88    88 
88~~~b.    88    88`8b   88`8b   88    88 
88   8D   .88.   88 `88. 88 `88. 88b  d88 
Y8888P' Y888888P YP   YD YP   YD ~Y8888P'
    print("""\n
\033[1;92m    _          _
\033[1;92m     \\        /
...
def hasil(ok,cp):
    if len(ok) != 0 or len(cp) != 0:
        ...
        if cek_cp =="":
            ...
            jalan(' %s[%s✓%s] Retrun SC type "%spython All-in1.py%s"'%(N,H,N,H,N));exit()
        elif cek_cp in["T","t"]:
            jalan(f"\n {N}[{H}•{N}] {N}Ok, thank you. Retrun SC type '{H}python All-in1.py{N}'");exit()
        else:
